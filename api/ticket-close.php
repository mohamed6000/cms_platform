...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION["tu_id"]) && isset($_SESSION["admin_id"]) &&
        ...
        if (isset($_GET["id"])) {
            $id_to_close = intval($_GET["id"]);
            if ($id_to_close) {
                $result = $ticket->close($id_to_close);
                if (true == $result) {
                    echo '<div class="col-sm-3">
                              <img src="assets/images/lock.png"> Fermé
                          </div>
                          <div class="col-sm-3">
                              <button pt-post="../api/ticket-open.php?id='.$id_to_close.'" 
                              ...
                              <a href="edit?id='.$id_to_close.'" class="btn btn-default btn-sm" title="Modifier">
                                <img src="assets/images/edit_ticket.png">
                              </a>
                              <button pt-post="../api/ticket-delete.php?id='.$id_to_close.'" 

...
$current = null;
if ($id) {
  $current = $store_product->get_single($id);
}
...
<head>
    ...
    <?php if ($current) { ?>
    <title>Administration | <?php echo $current["title"]; ?></title>
    <?php } else { ?>
    <title>Administration | Erreur 404</title>
    <?php } ?>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <?php if ($current) { ?>
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Boutique /</span> <?php echo $current["title"]; ?></h4>
              <?php } ?>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" pt-post="api/store-product-edit.php?id=<?php echo $id; ?>" pt-target="#result">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="title" name="title" placeholder="Nom du produit" value="<?php echo $current["title"]; ?>" autofocus="">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="brand" class="form-label">Nom du brand</label>
                            <input type="text" class="form-control" id="brand" name="brand" placeholder="Nom du brand" value="<?php echo $current["brand"]; ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="original_price" class="form-label">Prix original</label>
                            <input type="text" class="form-control" id="original_price" name="original_price" placeholder="Prix original" value="<?php echo $current["original_price"]; ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="new_price" class="form-label">Nouveau prix</label>
                            <input type="text" class="form-control" id="new_price" name="new_price" placeholder="Nouveau prix" value="<?php echo $current["new_price"]; ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="description" class="form-label">Déscription</label>
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Déscription"><?php echo $current["description"]; ?></textarea>
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="specification" class="form-label">Spécification</label>
                            <textarea class="form-control" id="specification" name="specification" rows="3" placeholder="Spécification"><?php echo $current["specification"]; ?></textarea>
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="stock" class="form-label">Quantité en stock</label>
                            <input type="number" min="0" class="form-control" id="stock" name="stock" placeholder="Quantité en stock" value="<?php echo (int)$current["stock"]; ?>">
                          </div>
                    ...
                    <?php } else { ?>
                    <h5 class="card-header">Le produit demandé n'a pas été trouvé.</h4>
                    <?php } ?>
                  </div>
                </div>
              </div>
